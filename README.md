...
This project demonstrate "Build a RAG System" in financial domain
...
answering questions from a bunch of quarterly financial results documents of the companies.

## 3. Document

1. The quartely result documents can be found [here](./Financials)
...
- Clone the github repository
  ```shell
  $ git clone https://github.com/kunal-mahale/semantic_spotter.git
  ```
- Open
  the [notebook](https://github.com/kunal-mahale/semantic_spotter/blob/main/semantic-spotter-langchain-notebook.ipynb)
